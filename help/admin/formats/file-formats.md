...
<table id="table_A3309E175ABF4651BD11CE3632B3C553"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>10位數的UTC、Unix時間戳記。 </p> <p>它也可以按照Java日期／時間戳 <code>記格式規則</code> ，格式化為YYYYMMDDhhmmss。 </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_E378F94A3907407AA8110C8EE6C10909"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <code>逗號</code> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>此巨集的輸出會將資料提供者ID(DPID)對應至相關的唯一使用者ID(DPUUID)。 此宏必須具有格式字串才能控制其輸出。 範例輸出看起來類似下列： </p> <p> <code>"dpids=dpid1,dpid2,...dpid n|maxMappings= n|format=json"</code> </p> <p>maxMappings <code>設定</code> ，會決定您要讓巨集傳回多少個對應。 當 <code>maxMappings=0</code>，此巨集會傳回每個指定DPID的所有映射。 資料會依時間戳記（最新的先行）排序，並傳回最大時間戳記優先的結果。 </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <code>endif</code> </p> </td> 
   <td colname="col2"> <p>使用條件 <code>if</code> 和 <code>SEGMENT_LIST</code> 和 <code>REMOVED_SEGMENT_LIST宏時需要</code> 。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>傳 <code>回</code> 1作為靜態、硬式編碼值。 </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>傳回清單中的區段清單。 接受下列可選變數： </p> 
    <ul id="ul_B111AA0D6C18445598A1444B8B7E9325"> 
     ...
     <li id="li_9BE103EFD8384464B46FAC00422431DB"> <code>類型</code>:傳回 <code>5</code>，此為靜態、硬式編碼值，可將資料識別為區段資料。 </li> 
     <li id="li_FE5049089F2944FA9DB9F9D546DBA167"> <code>別名</code>:區段的對應。 不再提倡。使用 <code>sid</code> （僅小寫）。 </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>傳回特徵清單。 接受以下可選參數： </p> 
    <ul id="ul_757DEB56E4F849768468F3C166B0D171"> 
     <li id="li_859E1F4F21D645519F150DC512B3EB1A"> <code>類型</code>:由數值ID識別的特徵類型。 此變數會傳回： 
     ...
     <li id="li_D30A849BA35248E6B9110FA3ADEFC332"> <code>lastRemailed</code>:上次這個特徵被發現。 Unix時間戳記。 </li> 
